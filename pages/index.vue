  ...
  <div class="body">
    <div class="main-wrap">
      ...
      <div class="container-wrap scroll-nav-content">
        ...
        <dots-parallax />
        <!--<section id="facility" class="space-top">
          <facilities />
        </section>-->
        <!--<section id="our-expertise" :class="[isTablet ? 'space-top-short' : 'space-top']">
          <expertise />
        </section>
        <section id="ask-doctors" :class="[isMobile ? 'space-top-short' : 'space-top']">
          <ask-doctors />
        </section>-->
        <section id="testimonials" class="space-top-short">
          <feature />
        </section>
        <section id="testimonials" class="space-top-short" style="background-color: #fcfcfc;">
          <v-container>
            <v-row>
              <v-col cols="12" class="text-center">
                <div class="text">
                  <h2 class="use-text-title2">Potenciando tu Práctica Médica</h2>
                  <div class="mx-auto text-center" style="border-radius: 10px;
                background: #000; width: 56px;
                height: 2px;
                flex-shrink: 0;">
                  </div>
                  <br>
                  <p class="subtitle use-text-subtitle2 text-center">Te brindamos las mejores herramientas para tu
                    consultorio. Adapta Medicae a tus necesidades y mejora la eficiencia y la calidad de tu servicio.</p>
                </div>
              </v-col>
            ...
            <v-row>
              <v-col cols="4">
                <v-card style="padding:15px; height:100%">
                  <svg style="margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" width="92" height="90"
                    viewBox="0 0 92 90" fill="none">
                  ...
                  <v-card-title><b>Solución integral</b></v-card-title>
                  <v-card-text>
                    Optimiza tareas diarias, permitiendo un mayor enfoque en la atención al paciente.
                  </v-card-text>
              ...
              <v-col cols="4">
                <v-card style="padding:15px; height:100%">
                  <svg style="margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" width="62" height="85"
                    viewBox="0 0 62 85" fill="none">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_27_36" x1="-2.08595e-07" y1="11.3333" x2="57.1389" y2="90.1944"
                        gradientUnits="userSpaceOnUse">
                  ...
                  <v-card-title><b>Eficiencia y productividad</b></v-card-title>
                  <v-card-text>
                    Gestiona tu consultorio en tiempo real desde cualquier lugar y dispositivo con conexión a internet.
                  </v-card-text>
              ...
              <v-col cols="4">
                <v-card style="padding:15px; height:100%">
                  <svg style="margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" width="68" height="95"
                    viewBox="0 0 68 95" fill="none">
                  ...
                  <v-card-title><b>Acceso universal</b></v-card-title>
                  <v-card-text>
                    Medidas de seguridad y cumplimiento de datos inigualables para
                    salvaguardar la información sensible de los pacientes.
                  </v-card-text>
            ...
            <v-row>
              <v-col cols="4">
                <v-card style="padding:15px; height:100%">
                  ...
                  <v-card-title><b>Solo la más alta calidad</b></v-card-title>
                  <v-card-text>
                    Interactúa fácilmente con pacientes y realiza seguimiento de su atención médica mediante chatbots
                    integrados a WhatsApp.
                  </v-card-text>
              ...
              <v-col cols="4">
                <v-card style="padding:15px; height:100%">
                  <svg style="margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" width="80" height="72"
                  ...
                  <v-card-title><b>Seguridad y Respaldo</b></v-card-title>
                  <v-card-text>
                    Interactúa fácilmente con pacientes y realiza seguimiento de su atención médica mediante chatbots
                    integrados a WhatsApp.
                  </v-card-text>
              ...
              <v-col cols="4">
                <v-card style="padding:15px; height:100%">
                  <svg style="margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" width="70" height="95"
                    viewBox="0 0 70 95" fill="none">
                  ...
                  <v-card-title><b>Personalización adaptativa</b></v-card-title>
                  <v-card-text>
                    Ajusta las herramientas a tus necesidades específicas para una gestión más eficaz y personalizada de
                    tu consultorio.
                  </v-card-text>
        ...
        <section id="testimonials" class="space-top-short">
          <section id="info" class="space-top-short">
            <v-container>
              <v-row>
                <v-col cols="12" class="text-center">
                  <h2 class="use-text-title2">Ayudamos a tu negocio a crecer mas rapido</h2>
                </v-col>
              </v-row>
              <v-row>
                <v-col cols="4">
                  <v-card>
                    <img src="https://framerusercontent.com/images/1GgS8SX7UN8xq45h1GLxkgJ6KXw.jpg?scale-down-to=512"
                      alt="Imagen 1" style="width: 400px; height: 250px;" />
                    <v-card-title><b>Solo la más alta calidad</b></v-card-title>
                    <v-card-text>
                      Funcionalidades avanzadas adaptadas a campos médicos específicos.
                    </v-card-text>
                ...
                <v-col cols="4">
                  <v-card>
                    <img src="https://framerusercontent.com/images/7csn8wUzh8sV4WBqz2oscDqVM.jpg?scale-down-to=512"
                      alt="Imagen 2" style="width: 400px; height: 250px;" />
                    <v-card-title><b>Interfaz de usuario amigable</b></v-card-title>
                    <v-card-text>
                      Experiencia de usuario fluida e interfaz intuitiva para mejorar la
                      productividad.
                    </v-card-text>
                ...
                <v-col cols="4">
                  <v-card>
                    <img src="https://framerusercontent.com/images/HY3iFPUbuprnZ44JyDcIUjoIjOY.jpg?scale-down-to=512"
                      alt="Imagen 3" style="width: 400px; height: 250px;" />
                    <v-card-title><b>Protección fortificada</b></v-card-title>
                    <v-card-text>
                      Medidas de seguridad y cumplimiento de datos inigualables para
                      salvaguardar la información sensible de los pacientes.
                    </v-card-text>
